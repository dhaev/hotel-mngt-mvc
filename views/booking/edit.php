   ...
   <form id="textForm"  action="<?= BASE_URL?>index.php?controller=Booking&action=edit" method="post">
      <div class="form-row justify-content-center">
         <div class="form-group col-md-4">
            ...
            <input type="date" class="form-control" name="checkin" id="cin" value="<?= htmlspecialchars($start_date, ENT_QUOTES, "UTF-8"); ?>" required>
         </div>
         <div class="form-group col-md-4">
            <label for="cout">Check out</label>
            <input type="date" class="form-control" name="checkout" id="cout" value="<?= htmlspecialchars($end_date, ENT_QUOTES, "UTF-8"); ?>" required>
         </div>
      </div>
