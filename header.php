...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>public/css/w3.css"> <!-- W3Schools CSS -->
...
<body>
   ...
   <a href="<?= BASE_URL ?>index.php?controller=Checkin&action=index" class="w3-bar-item w3-button w3-border-bottom w3-border-left w3-border-right">Check In</a>
   <a href="<?= BASE_URL ?>index.php?controller=Checkout&action=index" class="w3-bar-item w3-button w3-border-bottom w3-border-left w3-border-right">Check Out</a>
