...
<div class="w3-sidebar w3-mobile w3-bar-block w3-card w3-animate-left w3-brown w3-padding-top-64 w3-third" style="display:none" id="mySidebar">
  <button class=" w3-button w3-large w3-display-topright w3_close"> &times;</button>
   ...
   <a href="<?= BASE_URL ?>index.php?controller=Checkin&action=view" class="w3-bar-item w3-button w3-border-bottom w3-border-left w3-border-right">Check In</a>
   <a href="<?= BASE_URL ?>index.php?controller=Checkout&action=view" class="w3-bar-item w3-button w3-border-bottom w3-border-left w3-border-right">Check Out</a>
