...
class BookingModel {
    ...
    public static function addBooking($customerData, $start_date, $end_date, $rooms) {
        global $conn;
        ...
        try {
            ...
            $stmt = DatabaseHelper::executeQuery($conn, $sql, 'iss', $customerId, $start_date, $end_date);
            ...
            // Create Stripe end_date session
            $metadata = [
                'user_id' => $customerId,
            ...
            $checkoutSession = $stripe->end_date->sessions->create([
            ...
            // Return the Stripe end_date session URL
    ...
    public static function editBooking($reservationId, $start_date, $end_date, $rooms) {
        global $conn;
        $conn->begin_transaction();
...
// Update booking dates
            ...
            DatabaseHelper::executeQuery($conn, $sql, 'ssi', $start_date, $end_date, $reservationId);
            ...
            if ($amountDifference > 0) {
                ...
                self::createPaymentIntent($amountDifference, $reservationId, $start_date, $end_date, $rooms);
